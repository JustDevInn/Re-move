    ...
    <section id="toppage">
      ...
      <section className="relative w-screen h-[85vh] bg-informatie bg-cover bg-center flex justify-center items-center">
        <div className="absolute bottom-10 left-5 text-white p-5">
          <h1 className="text-[50px] lg:text-[120px] font-bold uppercase">
            Informatie
          </h1>
        </div>
      ...
      <section className="w-full py-20">
        <div className="px-10 lg:px-20">
          <div className="flex flex-col lg:flex-row lg:min-h-[80vh] w-full">
            {/* Oprichters */}
            <div className="lg:w-1/2 w-full shadow-xl bg-secondary p-5 rounded-xl lg:rounded-l-xl">
          ...
          {/* Programma & Doelgroep */}
          <div className="py-10 md:mt-20 flex flex-col lg:flex-row p-5 rounded-xl">
            <div className="lg:w-1/2">
              <h1 className="text-[35px] lg:text-[50px] uppercase font-bold tracking-widest">programma</h1>
              <p className="tracking-widest">
                Het programma helpt kinderen en jongeren van 8 tot 21 jaar die hun sociaal-emotionele vaardigheden willen verbeteren en op zoek zijn naar persoonlijke groei en ontwikkeling.
              </p>
            </div>
            <div className="lg:w-1/2 text-justify py-5 lg:py-0">
              <p className="tracking-widest">
                ...
                <br /><br />
                Onze doelgroep omvat kinderen en jongvolwassenen van 8 t/m 21 jaar die geïnteresseerd zijn in het verbeteren van hun sociaal-emotionele vaardigheden en op zoek zijn naar persoonlijke groei en ontwikkeling.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-screen">
        <div className="flex flex-col rounded-xl p-10 lg:p-20">
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            {/* Holisme Kaart */}
            <div className="lg:w-1/2 lg:p-10 py-10 p-5 rounded-b-lg shadow-lg tracking-widest text-justify">
              <p>
                ...
                <span className="font-bold uppercase">Leren door ervaring</span>: deelnemers leren door te doen. Zo wordt het makkelijker om emotionele vaardigheden in het dagelijks leven toe te passen.<br /><br />
                <span className="font-bold uppercase">Professionele coaching</span>: onze coaches zijn gespecialiseerd in zowel boksen als het bieden van emotionele begeleiding. Dit zorgt voor unieke kennis en vaardigheden om iedere deelnemer op de beste manier te kunnen helpen.<br /><br />
                <span className="font-bold uppercase">Persoonlijke aanpak</span>: we stemmen het programma af op wat elke deelnemer nodig heeft, gericht op hun eigen ontwikkeling en met aandacht voor persoonlijke groei.
              </p>
            </div>
          </div>
        </div>
